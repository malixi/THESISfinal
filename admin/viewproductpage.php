        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                while($row = mysqli_fetch_array($results)){
                    echo
                        "<tr>
                            <td><img class='img-thumbnail' id='prodImg' src='productimage/".$row['image']."' width='100px' height=''/></td>
                            <td>" .$row['productID']. "</td>
                            <td>" .$row['name']. "</td>
                            ...
                            <td>
                                ...
                                <div>
                                    <form method='POST' action='delproductprocess.php'>
                                        <input type='hidden' name='PNAME' value='".$row['productID']."' />
                                        <input type='submit' class='btn btn-danger col-lg-6' value='Delete' name='submit' Onclick=\"return ConfirmDelete()\">
                                    </form>
                                </div>
                            </td>
                        </tr>";
